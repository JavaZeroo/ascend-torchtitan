...
| **Qwen3.5** | 🟡 | `models/qwen3_5` | [📖](ascend_titan/models/qwen3_5/README.md) | 语言侧 0.8B 能训：单卡 12.88826 → 8.14589、FSDP2×8 → 8.06005，golden 冻结；视觉塔的 document mask 撞 910B2 限制；纯文本增量导致 DCP 续训缺视觉塔的优化器状态；GDN 无融合算子 |
